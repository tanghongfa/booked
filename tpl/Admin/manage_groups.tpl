...
<div class="admin" style="margin-top:30px">
	<div class="title">
		{translate key=AddGroup} (Please Add Group in Crowd and then use the Tab below to Sync)
	</div>
	<div>
...
<div class="admin" style="margin-top:30px">
	<div class="title">
		Sync Groups defined in Crowd
	</div>
	<div>
		<div id="addGroupResults" class="error" style="display:none;"></div>
		<form id="addGroupForm" method="post">
			<div>It will load and add all the groups defined in Crowd to Booked System.</div>
			<button type="button" class="button save">Sync Crowd Group</button>
		</form>
	</div>
</div>

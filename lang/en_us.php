...
class en_us extends Language
{
	...
	protected function _LoadStrings()
	{
		...
		// Email Subjects
		$strings['ReservationApprovedSubject'] = '[Proteus Booked %s] Your Reservation - %s - Was Approved';
		$strings['ReservationCreatedSubject'] = '[Proteus Booked %s] Your Reservation - %s - Was Created';
		$strings['ReservationUpdatedSubject'] = '[Proteus Booked %s] Your Reservation - %s - Was Updated';
		$strings['ReservationDeletedSubject'] = '[Proteus Booked %s] Your Reservation - %s - Was Removed';
		$strings['ReservationCreatedAdminSubject'] = '[Proteus Booked %s] Reservation Created: %s';
		$strings['ReservationUpdatedAdminSubject'] = '[Proteus Booked %s] Reservation Updated: %s';
		$strings['ReservationDeleteAdminSubject'] = '[Proteus Booked %s] Reservation Removed: %s';
		$strings['ReservationApprovalAdminSubject'] = '[Proteus Booked %s] Reservation Requires Approval: %s';
		$strings['ParticipantAddedSubject'] = '[Proteus Booked %s] Reservation Participation: %s';
		$strings['ParticipantDeletedSubject'] = '[Proteus Booked %s] Reservation Removed: %s';
		$strings['InviteeAddedSubject'] = '[Proteus Booked %s] Reservation Invitation: %s';
		$strings['ResetPassword'] = '[Proteus Booked] Password Reset Request';
		$strings['ActivateYourAccount'] = '[Proteus Booked] Account Activation';
		$strings['ReportSubject'] = '[Proteus Booked] Report Request (%s)';
		$strings['ReservationStartingSoonSubject'] = '[Proteus Booked] Reservation for %s is starting soon';
		$strings['ReservationEndingSoonSubject'] = '[Proteus Booked] Reservation for %s is ending soon';
		$strings['UserAdded'] = '[Proteus Booked] New User Added';
		// End Email Subjects

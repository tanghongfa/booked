...
$conf['settings']['default.timezone'] = 'Australia/Melbourne';
...
$conf['settings']['script.url'] = 'http://AU00055649.ericsson.se/booked';
$conf['settings']['image.upload.directory'] = 'booked/uploads/images';
...
$conf['settings']['home.url'] = 'http://localhost/booked/';
...
$conf['settings']['registration.cpptcha.enabled'] = 'true';
?>
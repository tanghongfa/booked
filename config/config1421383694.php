...
$conf['settings']['default.timezone'] = 'Australia/Melbourne';      // look up here http://php.net/manual/en/timezones.php
...
$conf['settings']['script.url'] = 'http://AU00055649.ericsson.se/booked';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
$conf['settings']['image.upload.directory'] = 'booked/uploads/images'; // full or relative path to where images will be stored
...
$conf['settings']['database']['password'] = 'wangchen';
 ...
 */
$conf['settings']['install.password'] = 'test';
/**
 * Pages
 */
